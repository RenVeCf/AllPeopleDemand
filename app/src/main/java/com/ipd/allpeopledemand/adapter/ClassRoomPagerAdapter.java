 ...
 * Time ： 2019/6/23.
 */
public class ClassRoomPagerAdapter extends BaseQuickAdapter<ClassRoomPagerBean.DataBean.RoomListBean, BaseViewHolder> {

    private String type;
    private int typeRes;

    public ClassRoomPagerAdapter(@Nullable List<ClassRoomPagerBean.DataBean.RoomListBean> data) {
        super(R.layout.adapter_class_room, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ClassRoomPagerBean.DataBean.RoomListBean item) {
