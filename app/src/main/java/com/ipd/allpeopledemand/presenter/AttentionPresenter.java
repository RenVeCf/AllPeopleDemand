...
public class AttentionPresenter extends AttentionContract.Presenter {
    ...
    public AttentionPresenter(Context context) {
        this.model = new AttentionModel();
        this.context = context;
    }

    @Override
    public void getMainDetails(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getMainDetails(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultMainDetails((MainDetailsBean) o);
                }
            }
    ...
    @Override
    public void getAttentionDetails(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getAttentionDetails(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultAttentionDetails((AttentionDetailsBean) o);
                }
            }
    ...
    @Override
    public void getReportList(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getReportList(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultReportList((ReportListBean) o);
                }
            }
    ...
    @Override
    public void getReport(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getReport(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultReport((ReportBean) o);
                }
            }
    ...
    @Override
    public void getMainAliPay(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getMainAliPay(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultMainAliPay((MainAliPayBean) o);
                }
            }
    ...
    @Override
    public void getMainWechatPay(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getMainWechatPay(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultMainWechatPay((MainWechatPayBean) o);
                }
            }
    ...
    @Override
    public void getMainBalancePay(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getMainBalancePay(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
