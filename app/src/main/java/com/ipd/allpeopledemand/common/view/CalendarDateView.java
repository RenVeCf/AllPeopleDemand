...
import static com.ipd.allpeopledemand.common.view.CalendarFactory.getMonthOfDayList;
...
public class CalendarDateView extends ViewPager implements CalendarTopView {
    ...
    private CalendarDateView.OnMonthChangedListener mOnMonthChangedListener;
    ...
    public CalendarDateView setOnMonthChangedListener(CalendarDateView.OnMonthChangedListener onMonthChangedListener) {
